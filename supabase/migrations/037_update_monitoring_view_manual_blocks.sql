-- Migration: 037_update_monitoring_view_manual_blocks.sql
-- Description: Updates view_athlete_monitoring_karo to use COALESCE on block
--              manual overrides, so Karoly can edit block values in Retool.
-- Date: 2026-02-13
...
WITH pace_data AS (
         SELECT a.id AS activity_id,
            ...
            -- Source flag: check both old flat overrides AND new block overrides
                CASE
            ...
            a.duration_sec,
            a.distance_m,
            -- Block 1: COALESCE manual over JSONB
            ...
            -- Block 2: COALESCE manual over JSONB
