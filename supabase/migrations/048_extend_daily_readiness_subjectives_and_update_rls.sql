ALTER TABLE public.daily_readiness
  ADD COLUMN IF NOT EXISTS sleep_quality double precision,
  ADD COLUMN IF NOT EXISTS mental_energy double precision,
  ADD COLUMN IF NOT EXISTS fatigue double precision,
  ADD COLUMN IF NOT EXISTS lifestyle double precision,
  ADD COLUMN IF NOT EXISTS sickness text,
  ADD COLUMN IF NOT EXISTS alcohol text;

DROP POLICY IF EXISTS "coach_update_daily_readiness" ON public.daily_readiness;

CREATE POLICY "coach_update_daily_readiness"
