...
export function FocusCoach({ alert }: FocusCoachProps) {
  ...
  return (
    <div className="rounded-sm border border-red-300 bg-red-50 p-4 dark:border-red-800/60 dark:bg-red-950/30">
      <div className="flex items-start gap-3">
        <div className="rounded-sm bg-red-100 p-2 dark:bg-red-900/40">
            ...
            {alert.sessions.map((session) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="flex-1 group-hover:text-red-700 dark:group-hover:text-red-300 transition-colors">{session.name}</span>
