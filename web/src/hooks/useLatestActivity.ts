...
const COLUMNS =
  "id, session_date, sport_type, source_sport, work_type, activity_name, manual_activity_name, duration_sec, moving_time_sec, distance_m, load_index, rpe, avg_hr, coach_comment";
