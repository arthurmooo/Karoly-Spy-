...
function makeActivityRow(overrides: Record<string, unknown> = {}) {
  return {
    ...
    manual_interval_block_3_power_mean: null,
    manual_interval_block_3_power_last: null,
    manual_interval_block_3_hr_mean: null,
    manual_interval_block_3_hr_last: null,
    manual_interval_block_3_pace_mean: null,
    manual_interval_block_3_pace_last: null,
    manual_interval_block_3_count: null,
    manual_interval_block_3_duration_sec: null,
