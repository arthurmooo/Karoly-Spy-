...
- **Hybrid Interval Engine:** Surgical segmentation of complex workouts using a three-tier fusion strategy: theoretical plan correlation, manual/automatic lap analysis, and high-fidelity ULTRA signal analysis (Histogram Valley & Gradient Refinement).
