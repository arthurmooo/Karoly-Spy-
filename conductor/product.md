...
- **Hybrid Interval Engine:** Surgical segmentation of complex workouts using a three-tier fusion strategy: theoretical plan correlation, manual/automatic lap analysis, and algorithmic signal rupture detection (K-Means).
