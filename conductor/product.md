...
- **Hybrid Interval Engine:** Surgical segmentation of complex workouts using a four-tier fusion strategy: theoretical plan correlation, manual/automatic lap analysis, ULTRA signal analysis (Histogram Valley), and **Surgical Plan-Driven Seeker** (Cross-correlation & Gradient Refinement for <1s error).
